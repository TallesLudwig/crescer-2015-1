-- Feito o medelo logico>modelo Relacional> .sql
-- Gerado por Oracle SQL Developer Data Modeler 4.0.3.853
--   em:        2015-04-17 14:14:11 BRT
...
CREATE
  ...
  (
    ...
    Valor_Item DECIMAL (9,3) NOT NULL ,
...
ALTER TABLE Item ADD CONSTRAINT Item_Produto_FK FOREIGN KEY(
IDProduto
)
REFERENCES Produto(
IDProduto
