...
TelaConsulta.prototype.render = function() {
  // lembram-se do comportamento de closures ? dependendo da situação this deixar de ser this.. por isso a forma mais fácil é guardarmos o contexto no self
  var self = this;
