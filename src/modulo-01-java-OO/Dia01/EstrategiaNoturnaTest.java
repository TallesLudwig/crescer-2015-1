...
public class EstrategiaNoturnaTest
{
    ...
    public void tresElfosNoturnosEm9AtaquesApenasDoisAtacam() throws ErrorAlistarException {
        ...
        // Assert
        assertEquals(39, night3.getFlechas()); // perdeu 1 flecha por orc
    ...
    @Test
    public void testElfosNoturnosEElfoVerdesTodosAtacam() throws ErrorAlistarException {
        // Arrange
        ExercitoDeElfos exercito = new ExercitoDeElfos();
        exercito.mudaDeEstrategia(new EstrategiaNoturna());
        Elfo night1 = new ElfoNoturno("Night 1");
        Elfo night2 = new ElfoNoturno("Night 2");
        Elfo night3 = new ElfoNoturno("Night 3");
        Elfo green1 = new ElfoVerde("Green 3");
        Elfo green2 = new ElfoVerde("Green 3");
