...
setTimeout(function(){ console.log('caiu a ficha!');}, 2000);  // apos 2 segundo mostra a mensagem


var i= setInterval(function(){ console.log('caiu a ficha!');}, 2000);// acada 2 segundo mostra a mensagem
clearInterval(i);
